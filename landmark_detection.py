...
# CSV file setup
csv_filename = 'insightface_latest.csv'
# Define the headers for the CSV file
headers = ['chin_angle_1', 'chin_angle_2', 'cheek_bone_angle', 'ratio_1', 'ratio_2', 'ratio_3', 'ratio_4',
           'ratio_5','ratio_6','n1', 'n2', 'n3', 'n4', 'n5', 'n6', 'n7', 'n8', 'n9', 'n10', 'n11', 'n12']
...
def measurements_calculation():
    ...
    def process_image_insightface(image_path):
        ...
        try:
            ...
            def normalized_distance(distance):
                values = [forehead_width, cheekbone_width, jawline_length, facial_length, D5, D6, D7, D8]
    ...
    with open(csv_filename, 'w', newline='') as file:
        ...
        for image_path in image_paths:
            process_image_dlib(image_path)
            measurements = process_image_insightface(image_path)
